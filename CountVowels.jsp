...
<head>
	...
	<meta name="keywords" content="Java program for count the Vowels of the Given String?, vowels count in java program,">
	<meta name="description" content="This java program explains the  Vowels of the string">
...
<div class="row">
	...
	<div class="span9">	
		...
		<h1 class="h1">Java program for count the Vowels of the Given String?</h1>
...
<h4>Output</h4>
<pre class="p1">
Enter the string: I love my mom
There are  3 vowels and 10  consonants
</pre>
