...
<head>
	<meta charset="utf-8">
	<title>EquilateralTriangle</title>
	<meta name="keywords" content="write a java program to print the equilateral triangle?, Equilateral triangle java program, printing stars of the program,java program for printing the equilataral triangle?">
	<meta name="description" content="This java program explains the how to make equilateral triangle">
...
<div class="row">
	...
	<div class="span9">	
		...
		<h1 class="h1">write a java program to print the Equilateral Triangle ?</h1>
