...
<head>
	<meta charset="utf-8">
	<title>Polindrom Number</title>
	<meta name="keywords" content="Write a java program to given number is polindrom or not?,Write a Java Program to find weather given number is polindrom or not ?, polindrom number java program">
	<meta name="description" content="This java program explains the given number is polindrom number or not.">
...
<div class="row">
	...
	<div class="span9">	
		...
		<h1 class="h1">Write a java program to given number is polindrom or not?</h1>
...
public class PolindromeNumber {
	...
	public static void main(String [] args) throws IOException{  
		  int r,n1,n2,rev=0;  
		   ...
		   if(rev==n2) {  
		    System.out.println("The "+n2+"  is Palindrome Number.");  
		   } else {  
		    System.out.println("The "+n2+"  is not a Palindrome Number.");  
		   }  
	}  
}  
</pre>
...
The 1551  is Palindrome Number.

Enter the number: 15634
The 15634  is not a Palindrome Number.
</pre>
