...
<head>
	<meta charset="utf-8">
	<title>Polindrom String</title>
	<meta name="keywords" content="Write a java program to given String is polindrom or not?,Write a Java Program to find weather given String is polindrom or not ?, polindrom String java program,String polindrom">
	<meta name="description" content="This java program explains the given String is polindrom number or not.">
...
<div class="row">
	...
	<div class="span9">	
		...
		<h1 class="h1">Write a java program to given String is polindrom or not?</h1>
...
<h4>Output</h4>
<pre class="p1">
Enter a string to check if it is a palindrome::    it is my love story
Entered string is not a palindrome.


Enter a string to check if it is a palindrome:: amma
